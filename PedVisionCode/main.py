...
def main():
    ...
    parser.add_argument('--round', type=int, default=11, help='Round number (starting from 0)')
    ...
    parser.add_argument('--CLS_model_name', type=str, default='EffiB5', help='Classifier model: MobileNet, EffiB1, or EffiB5')
